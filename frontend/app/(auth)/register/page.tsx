...
import { Eye, EyeOff, Lock, Mail, User, ArrowRight, CheckCircle, Scale, FileText, Shield, Languages, Sparkles } from 'lucide-react';
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-md">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Join LexAI and transform your legal workflow with enterprise-grade AI capabilities.
            </p>
